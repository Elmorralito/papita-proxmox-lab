...
from pfsense_mcp.context import get_client, init_context
from pfsense_mcp.logging_config import configure_logging
from pfsense_mcp.tools.register import register_tools

logger = logging.getLogger("pfsense_mcp.server")
MCP_SERVER_NAME = "pfsense"
...
def main() -> None:
    ...
    async def _run() -> None:
        """Run the MCP stdio server and close the pfREST client on shutdown."""
        try:
